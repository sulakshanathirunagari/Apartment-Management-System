...
$sql=mysqli_query($con,"SELECT password FROM admin where password='$oldpass' && userEmail='$useremail'");
$num=mysqli_fetch_array($sql);

if($num>0)
{
 $con=mysqli_query($con,"update admin set password='$newpassword' where userEmail='$useremail'");
