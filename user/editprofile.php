...
$id=$_SESSION['login'];
  ...
  if(isset($_POST['submit']))
  {
    ...
    $block=$_POST['block'];
    $flatno=$_POST['flatno'];
    $upt=mysqli_query($con,"update user set firstName='$first',	lastname='$last',contactNo='$contact',block='$block',flatNumber='$flatno' where userEmail='$id'");
    echo "<script>alert('values updated sucessfully');</script>";
    header('location:http://localhost/Apartment_Management_System/user/editprofile.php');
}
 ?>
          ...
          <div class="col-md-9 personal-info">
            ...
            <form class="form-horizontal" role="form"  method="post" autocomplete="off">
              <div class="form-group">
                ...
                <div class="col-lg-8">
              <?php  echo "<input class='form-control' type='number' value= '".$row['Userid']."' readonly>"
                ?>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  ...
                  <?php  echo"<option>".$row['block']."</option>"
                      ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <?php  echo "<input class='form-control' type='text' name='flatno' value= '".$row['flatNumber']."'   >"
                    ?>
                </div>
              </div>
